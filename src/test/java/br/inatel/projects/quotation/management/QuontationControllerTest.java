...
//		webTestClient.get().uri("/stock").exchange().expectHeader().contentType(MediaType.APPLICATION_JSON)
//				.expectStatus().isOk();
//	}
//
//	/**
...
//		webTestClient.get().uri("/stock/petr4").accept(MediaType.APPLICATION_JSON).exchange().expectStatus().isOk();
//	}
//
//	/**
...
//		webTestClient.get().uri("/stock/Invalid").accept(MediaType.APPLICATION_JSON).exchange().expectStatus()
//				.isNotFound();
//	}
//
//	/**
...
//		webTestClient.post().uri("/stock").body(BodyInserters.fromValue(stockForm)).exchange().expectHeader()
...
//		Map<LocalDate, BigDecimal> quoteMap = new HashMap<>();
//		LocalDate date = LocalDate.now();
//		quoteMap.put(date, new BigDecimal(50.0));
//		quoteMap.put(date.plusDays(2), new BigDecimal(75.0));
